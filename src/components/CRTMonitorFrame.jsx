...
const CRTMonitorFrame = ({ children }) => {
  ...
  // Screen position percentages - adjusted for hawkinslabdemo3
  const screen = {
    top: '15%',
    left: '25%',
    width: '40%',
  ...
  return (
    <div style={{
      ...
      {/* Monitor container - maintains aspect ratio */}
      <div style={{
        position: 'relative',
        width: '100%',
        maxWidth: '1400px',
        aspectRatio: '2752 / 1536', // Match image aspect ratio
      }}>
        {/* The CRT monitor frame image (background) */}
        <img
          src="/hawkinslabdemo3.jpeg"
          alt="CRT Monitor"
          style={{
            position: 'absolute',
            top: 0,
        ...
        {/* Screen content area - positioned over the screen */}
        <div style={{
          position: 'absolute',
          top: screen.top,
          left: screen.left,
        ...
        {/* Controls row - audio toggle + share buttons */}
        <div style={{
          position: 'absolute',
          bottom: '6%',
          right: '8%',
          ...
          <button
            ...
            onMouseOver={(e) => {
              ...
              e.currentTarget.style.boxShadow = '0 0 10px rgba(255,176,0,0.5)';
            }}
            onMouseOut={(e) => {
