...
const CRTMonitorFrameMobile = ({ children }) => {
  ...
  if (frameless) {
    return (
      <>
        {/* Terminal container - fixed position with concrete dimensions */}
        <div style={{
          position: 'fixed',
          top: 0,
          left: 0,
          width: 'calc(100% - 50px)', // Make room for side controls
          height: '100%',
          background: '#0a0a0a',
          zIndex: 1,
        }}>
        ...
        {/* Controls - vertical along right edge */}
        <div style={{
          position: 'fixed',
          right: '8px',
          top: '50%',
          ...
          <button
            onClick={() => {
              trackEvent('frame_toggle', { mode: 'framed', device_type: 'mobile' });
              setFrameless(false);
            }}
            style={{
              width: '32px',
          ...
          <button
            onClick={() => {
              trackEvent('social_share', { platform: 'twitter', device_type: 'mobile' });
          ...
          <button
            onClick={() => {
              trackEvent('social_share', { platform: 'reddit', device_type: 'mobile' });
          ...
          <button
            onClick={() => {
              trackEvent('social_share', { platform: 'copy_link', device_type: 'mobile' });
          ...
          <button
            onClick={() => {
              trackEvent('audio_toggle', { action: isMuted ? 'unmute' : 'mute', device_type: 'mobile' });
              setIsMuted(!isMuted);
            }}
            style={{
              width: '32px',
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <button
            onClick={() => {
              trackEvent('social_share', { platform: 'facebook', device_type: 'mobile' });
              const url = window.location.href;
          ...
          {/* Frame toggle - go fullscreen */}
          <button
            onClick={() => {
              trackEvent('frame_toggle', { mode: 'frameless', device_type: 'mobile' });
              setFrameless(true);
            }}
            style={{
              width: '36px',
